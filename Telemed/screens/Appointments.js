    ...
    const ItemView = ({ item }) => {
        return (
            <View style={{width:300,margin: 10}}>
                <View>
                    <Text style={{ fontSize: 15, color: '#333333', fontFamily: 'SpaceGrotesk-Regular'}}>{item.next}</Text>
                    <Text style={{ fontSize: 15, color: '#333333',left: 245, position: 'absolute',fontFamily: 'SpaceGrotesk-Regular' }}>{item.time}</Text>
                </View>
  ...
  return (
    <View style={{flex:1,backgroundColor:'#11266c'}}>
       <View style={{ height: 50, }}>
            ...
            <View style={{height:445,backgroundColor:'#dcdcdc',borderRadius:8}}>
            <View style={{height:260,backgroundColor:'#eaeaea',marginLeft:15,marginRight:15,borderRadius:8,marginTop:-130}}>
            <FlatList
                    data={Menu}
                    renderItem={ItemView}
            ...
            <ScrollView >
                <TouchableOpacity onPress={() => { SetShowInfo(!showInfo) }}>
                    ...
                    <Text style={{ color: '#333333', marginTop: -15, marginLeft: 180,top:-5 }}>14</Text>
                </TouchableOpacity>
                <Text style={{borderBottomColor:'#333333',borderBottomWidth:1,marginLeft:20,marginRight:20,}}/>
                {
                    showInfo ? (
                        ...
                        <View style={{ width: 200, height: 125, marginLeft: 30, marginTop: -20 }}>
                            <View><Text style={{ color: '#808080', fontSize: 13, marginTop: 35, marginLeft: 20 ,fontFamily: 'SpaceGrotesk-Regular'}}>Telemed</Text>
                            <Text style={{ color: '#333333', fontSize: 14,fontFamily: 'SpaceGrotesk-Regular',marginTop: 35,position:'absolute', marginLeft: 148,}}>09     <Feather style={{ color: '#808080',position:'absolute'}} name='chevron-right' size={15}/></Text></View>
                            <View><Text style={{ color: '#808080', fontSize: 13, marginTop: 15, marginLeft: 20 ,fontFamily: 'SpaceGrotesk-Regular'}}>TCM</Text>
                            <Text style={{ color: '#333333', fontSize: 14, marginTop: 15,position:'absolute', marginLeft: 148,fontFamily: 'SpaceGrotesk-Regular'}}>--      <Feather style={{ color: '#808080',position:'absolute'}} name='chevron-right' size={15}/></Text></View>
                            <View><Text style={{ color: '#808080', fontSize: 13, marginTop: 15, marginLeft: 20,fontFamily: 'SpaceGrotesk-Regular' }}>Out Patient</Text>
                            <Text style={{ color: '#333333', fontSize: 14, marginTop: 15,position:'absolute', marginLeft: 148,fontFamily: 'SpaceGrotesk-Regular' }}>05     <Feather style={{ color: '#808080',position:'absolute'}} name='chevron-right' size={15}/></Text></View>
                        </View>
                        </TouchableOpacity>
                ...
                <TouchableOpacity onPress={() => { SetShowContact(!showContact) }}>
                    ...
                    <Text style={{ color: '#333333', marginTop: -15, marginLeft: 180,top:-5 }}>13</Text>
                </TouchableOpacity>
                <Text style={{borderBottomColor:'#333333',borderBottomWidth:1,marginLeft:20,marginRight:20}}/>
                {
                    showContact ? (
                ...
                <Entypo name='plus' size={24} style={{ color: '#e6c402',  marginTop: 25, marginLeft: 20 }}/>
                    ...
                    <Text style={{ color: '#333333', marginTop: -15, marginLeft: 180,top:-5 }}>09</Text>
                </TouchableOpacity>
                <Text style={{borderBottomColor:'#333333',borderBottomWidth:1,marginLeft:20,marginRight:20}}/>
                {
                    showSpecial ? (
                ...
                <Entypo name='plus' size={24} style={{ color: '#e6c402',  marginTop: 25, marginLeft: 20 }}/>
                    ...
                    <Text style={{ color: '#333333', marginTop: -15, marginLeft: 180,top:-5 }}>02</Text>
                </TouchableOpacity>
                <Text style={{borderBottomColor:'#333333',borderBottomWidth:1,marginLeft:20,marginRight:20}}/>
                {
                    showAvail ? (
